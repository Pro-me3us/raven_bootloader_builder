...
################################################################################
export PATH="$PATH:/opt/toolchains/gcc-linaro-aarch64-none-elf-4.8-2013.11_linux/bin"
export PATH="$PATH:/opt/toolchains/gcc-linaro-arm-none-eabi-4.8-2013.11_linux/bin"
